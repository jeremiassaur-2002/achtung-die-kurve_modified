...
config (ai/v1_0/config/phase{1..5}.yaml) - env/PPO hyperparameters, curriculum stages,
...
Warm start via behavior cloning (recommended before Phase 1, see bc_pretrain.py):
    python -m ai.v1_0.training.bc_pretrain --config ai/v1_0/config/phase1.yaml --out ai/runs/bc/bc_model.zip
    python -m ai.v1_0.training.train --config ai/v1_0/config/phase1.yaml --init-from ai/runs/bc/bc_model.zip
"""
...
from ai.v1_0.models.algo import build_algo_kwargs, load_trained, resolve_algo
from ai.v1_0.models.policy import build_policy_kwargs
from ai.v1_0.training.callbacks import (
    CurriculumCallback,
    EvalEloCallback,
    LeagueCallback,
...
from ai.v1_0.training.curriculum import CurriculumManager, CurriculumStage
from ai.v1_0.training.drive_callbacks import BestModelCallback, RotatingCheckpointCallback, VideoCallback
from ai.v1_0.training.run_persistence import latest_checkpoint
from ai.v1_0.training.league import League
from ai.v1_0.training.self_play import SelfPlayPool
...
def make_configs(cfg: dict) -> tuple[ObsConfig, CurveEnvConfig]:
    ...
    ai/v1_0/training/bc_pretrain.py so behavior-cloning data goes through the IDENTICAL
