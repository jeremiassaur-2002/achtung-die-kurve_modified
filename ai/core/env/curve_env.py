...
("the hero"). Every other seat is driven by a Controller (ai/core/env/opponents.py) -
...
from ai.core.env.engine import CurveEngine, STRAIGHT, TURN_LEFT, TURN_RIGHT, _mcos, _msin
from ai.core.env import sensors
from ai.core.env.observation import ObsConfig, ObservationBuilder, vector_dim
from ai.core.env.opponents import Controller, EpisodeConfig
