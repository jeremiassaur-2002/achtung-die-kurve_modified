...
timer here has a direct counterpart in the JS source (see ai/config/game_constants.py
...
kill stats, and is what ai/env/renderer.py recolors into the CNN's RGB observation.
